<?php
define ("USER_PARAM_ABSENT",['code' => 100, 'text' => 'Параметр пользователя не передан!']);
define ("UNDEFINED_METHOD",['code' => 101, 'text' => 'Неопознанный метод!',"page" => 'undef_method']);
define ("CALLBACK_ERROR",['code' => 102, 'text' => 'Callback conditions are not met','page'=>'callback_error']);
define ("DELETE_CONFIRM",['code' => 103, 'text' => 'Пользователь успешно удален!']);
define ("EXECUTE_ERROR",['code' => 104, 'text' => 'Невозможно выполнить!']);
...
define ("AUTH_ERROR",['code' => 110, 'text' => 'Ошибка авторизации','page'=>'auth_error']);
...
define ("CREATE_SUCCESS",['code' => 114, 'text' => 'Пользователь успешно добавлен!']);
define ("CREATE_ERROR",['code' => 115, 'text' => 'Не удалось добавить пользователя!']);
define ("PARAM_ERROR",['code' => 116, 'text' => 'Идентификатор параметра не найден!']);
...
define ("PERFORM_QUERY_ERROR",['code' => 120, 'text' => 'Не удалось выполнить запрос к базе данных!', 'page'=>'error']);
define ("UNDEFINED_CUSTOM_NAME",['code' => 121, 'text' => 'Parameter \'name\' did not found !']);
...
define ("COOKIE_SET_ERROR",['code' => 131, 'text' => 'Не удалось установить cookie!']);
define ("COOKIE_GET_ERROR",['code' => 132, 'text' => 'Не удалось получить cookie!', 'page' => 'cookie_error']);
define ("FILE_PARAM_ABSENT",['code' => 133, 'text' => 'Параметр файла не передан!', "page" => 'no_file_param']);
define ("DIRECT_UPLOAD",['code' => 134, 'text' => 'Загрузка не из формы!', "page" => 'error']);
...
define ("NO_FILE_UPLOAD",['code' => 138, 'text' => 'Нет загруженного файла', "page" => 'error']);
define ("FILE_DELTE_BASE_ERROR",['code' => 139, 'text' => 'Не удалось удалить файл из базы', "page" => 'error']);
define ("FILE_DELTE_ERROR",['code' => 140, 'text' => 'Не удалось удалить файл физически', "page" => 'error']);
...
define ("ZIP_OPEN_ERROR",['code' => 144, 'text' => 'Невозможно открыть архив', "page" => 'error']);
...
define ("ARRAY_TO_XML_CONVERT_ERROR",['code' => 155, 'text' => 'Ошибка конвертации массива в XML']);
...
define ("ARRAY_KEY_NOT_FOUND",['code' => 159, 'text' => 'Не найден ключ в массиве', 'page'=>'error']);
define ("EVENT_DELETE_CONFIRM",['code' => 160, 'text' => 'Событие успешно удалено!']);
define ("ADDRESS_WRITE_ERROR",['code' => 161, 'text' => 'Ошибка записи адреса!', 'page'=>'error']);
define ("ADDRESS_DESTROY_ERROR",['code' => 162, 'text' => 'Ошибка удаления адреса!', 'page'=>'error']);
define ("NO_TYPES_FOUND",['code' => 163, 'text' => 'События не найдены!', 'page'=>'error']);
define ("LOG_ERROR",['code' => 164, 'text' => 'Ошибка логирования', 'page'=>'error']);
...
define ("CREATE_COUNTRY_TABLE_ERROR",['code' => 170, 'text' => 'Не удалось создать таблицу адреса!', 'page'=>'error']);
define ("COUNTRY_NOT_FOUND",['code' => 171, 'text' => 'Не удалось найти страну в справочнике!', 'page'=>'error']);
...
define ("PORT_UPDATE_TYPE_VALIDATION_ERROR",['code' => 191, 'text' => 'Неверный формат данных','page'=>'update_validation_event_type_error']);
...
define ("CREATE_DIFF_ERROR",['code' => 195, 'text' => 'Ошибка создания файла различий!']);
define ("READ_DIFF_ERROR",['code' => 196, 'text' => 'Ошибка чтения различий!']);
