...
<div id="node_002" class="users">
    <form action="/users" method="GET" name="formname" id="form_id" class="form">
        <h1 class="header">фильтр пользователей</h1>
        <label>Ник: </label>
        ...
        <select name="order"><option value="username">Ник</option>
            <option value="lastname">Фамилия</option>
            <option value="firstname">Имя</option>
            <option value="middlename">Отчество</option></select><br>
        <label><input type="submit" value="Поиск" class="active"></label>
    </form>
</div>
    ...
    <table style="width:100%">
        ...
        <?php
            foreach ($user_data as $user) {
                ...
                echo "<td>[<a href=\"/users/show?id={$user['id_user']}\">Просмотр</a> | <a href=\"/users/update_menu?id={$user['id_user']}\">Редактирование</a>";
//                if (!User::checkSelfSession($user['id_user'])) {
//                    echo " | <a href=\"/users/destroy/confirm?id={$user['id_user']}\">Удалить</a>]";
//                }
                echo " | <a href=\"/users/destroy/confirm?id={$user['id_user']}\">Удалить</a>]";
                echo "</tr>";
            }
